...
(function (Willa) {
    ...
    (function (DriveController) {
        class DriveControl {
            ...
            /**
             * @param flatbuffers.Builder builder
             * @param number backLights
             */
            static addBackLights(builder, backLights) {
                builder.addFieldInt16(4, backLights, 0);
            }
            ;
            /**
             * @param flatbuffers.Builder builder
            ...
            ;
            static createDriveControl(builder, steer, motorMode, motorPower, frontLights, backLights, horn) {
                ...
                DriveControl.addBackLights(builder, backLights);
...
//# sourceMappingURL=controller_generated.js.map