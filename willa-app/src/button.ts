import { LitElement, PropertyValueMap, css, html, svg, unsafeCSS } from 'lit';
...
export class ToggleChoices extends LitElement {
  @property({ type: String })
  selected: string = '';
  ...
  private updateSlots() {
    ...
    if (slot) {
      slot.assignedElements({ flatten: true }).forEach((el: Element) => {
...
export class ToggleButtonChoice extends LitElement {
  @property({ type: String })
  value: string = '';
  @property({ type: Boolean })
  toggled: boolean = false;
  ...
  protected onClick(ev: Event): void {
    ev.stopPropagation();
    this.dispatchEvent(
...
export class IconGame extends LitElement {
  render() {
...
export class IconHorn extends LitElement {
  render() {
...
export class IconLightsOff extends LitElement {
  render() {
...
export class IconLightsOn extends LitElement {
  render() {
...
export class IconLightsHigh extends LitElement {
  render() {
...
export class IconExit extends LitElement {
  render() {
...
export class IconRace extends LitElement {
  render() {
...
export class IconDebug extends LitElement {
  render() {
